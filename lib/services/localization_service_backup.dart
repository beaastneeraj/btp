...
class LocalizationService {
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'satelliteIotVoiceIntegration': 'Satellite • IoT • Voice Integration',
      'advancedFeatures': 'Advanced Features',
      'satelliteMonitoring': 'Satellite Monitoring',
      'realTimeNdviWeather': 'Real-time NDVI & Weather',
      'iotIntegration': 'IoT Integration',
      'smartSensorsControl': 'Smart Sensors & Control',
      'voiceControl': 'Voice Control',
      'multiLanguageCommands': 'Multi-language Commands',
      'aiAnalysis': 'AI Analysis',
      'cropHealthPrediction': 'Crop Health Prediction',
      'liveData': 'Live Data',
      ...
      'tryVoiceCommands': 'Try saying: "मौसम कैसा है?" or "Check soil moisture"',
      'listening': 'Listening...',
    ...
    'hi': {
      ...
      // Advanced Features
      'smartFarm': 'स्मार्ट खेती',
      'smartAgriculturePlatform': 'स्मार्ट कृषि प्लेटफॉर्म',
      'satelliteIotVoiceIntegration': 'सैटेलाइट • IoT • वॉयस इंटीग्रेशन',
      'advancedFeatures': 'उन्नत सुविधाएं',
      'satelliteMonitoring': 'सैटेलाइट निगरानी',
      'realTimeNdviWeather': 'रियल-टाइम NDVI और मौसम',
      'iotIntegration': 'IoT इंटीग्रेशन',
      'smartSensorsControl': 'स्मार्ट सेंसर और नियंत्रण',
      'voiceControl': 'वॉयस कंट्रोल',
      'multiLanguageCommands': 'बहुभाषी कमांड',
      'aiAnalysis': 'AI विश्लेषण',
      'cropHealthPrediction': 'फसल स्वास्थ्य पूर्वानुमान',
      'liveData': 'लाइव डेटा',
      ...
      'checkCrops': 'फसल जांचें',
      'startIrrigation': 'सिंचाई शुरू करें',
      'launchDrone': 'ड्रोन लॉन्च करें',
      ...
      'tryVoiceCommands': '"मौसम कैसा है?" या "Check soil moisture" कहकर देखें',
